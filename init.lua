...
vim.api.nvim_create_user_command('LiveServer', function()
  local file = vim.fn.expand '%:h' -- Get full path of current file
...
require('lazy').setup({
...

  {
    ...
    config = function()
      require('web-tools').setup {
        keymaps = {
          rename = nil, -- Disable renaming
          repeat_rename = '.', -- Repeat rename with .
        },
      }
    end,
  },
  {
    ...
    -- LSP (IntelliSense & autocompletion)
